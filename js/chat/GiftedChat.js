...
class GiftedChat extends React.Component
{
  ...
  addMsgs(msgs=[])
  {
    ...
    {
      this._messageContainerRef.addMsgs(msgs);
    }
  }
  ...
  {
    if(this._messageContainerRef && this._messageContainerRef.toggleSpeakTip)
      this._messageContainerRef.toggleSpeakTip(btnStatus);
  }
  ...
  renderInputToolbar()
  {
    const inputToolbarProps = {
      ...
      onSend: this.onSend,
      toggleSpeakTip:this.toggleSpeakTip.bind(this),
    };
