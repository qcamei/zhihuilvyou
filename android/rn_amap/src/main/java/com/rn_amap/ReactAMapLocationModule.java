...
public class ReactAMapLocationModule extends ReactContextBaseJavaModule implements AMapLocationListener {
    ...
    private static ReactAMapLocationModule _instance;
    /**单例*/
    public static ReactAMapLocationModule getInstance(ReactApplicationContext reactContext,boolean bNew)
    {
        if(bNew || _instance==null) {
            if(_instance!=null)
            {
            ...
            _instance = new ReactAMapLocationModule( reactContext );
        }
        return _instance;
    }
    public void setMap(ReactAMapView map)
    {
        this.rnAmap = map;
    ...
    public void onLocationChanged(AMapLocation aMapLocation) {
        ...
        if(this.rnAmap!=null)
        {
            this.rnAmap.onLocationChange( aMapLocation );
        }
    }
