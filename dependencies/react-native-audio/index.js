...
import React, { NativeModules, NativeAppEventEmitter, DeviceEventEmitter, Platform } from 'react-native';
...
var AudioPlayer = {
  ...
  {
    if (this.startSubscripition) this.startSubscripition.remove();
    this.startSubscripition = DeviceEventEmitter.addListener('playerStart',
      (data) =>
      {
        if (this.onStart)
        {
