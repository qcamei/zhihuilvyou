...
class AudioRecorderManager extends ReactContextBaseJavaModule {
  ...
  public AudioRecorderManager(ReactApplicationContext reactContext) {
    ...
    AudioWrapperManager.instanceAudioWrapper.setAudioRecorderManager( this );
  }
  ...
  public void stopRecording(Promise promise){
    ...
    {
      /**无视*/
      /*a RuntimeException is intentionally thrown to the application,if no valid audio/video data has been received when stop() is called.
